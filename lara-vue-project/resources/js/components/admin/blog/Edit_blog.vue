                    ...
                    <div class="container-fluid">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="m-0">Add Blog Info</h3>
                                <h4 class="btn btn-warning" style="margin-left:93%">
                                    <router-link to="/blog">Show</router-link></h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
    ...
    methods: {
        getblog() {
            axios.get(`/api/blog/${this.id}`).then((response) => {
                ...
                this.Badge = response.data.data.Badge;
                this.date = response.data.data.date;
                this.maindetails = response.data.data.maindetails;
        ...
        update() {
            ...
            formData.append("maindetails", this.maindetails);
